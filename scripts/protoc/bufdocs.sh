...
# also make sure that you are added to the OLLO organization on buf
...
buf mod update $OLLOPROTO

# then, push the OLLO proto module and documentation 
buf push $OLLOPROTO

# two commit addresses should be printed to the command line
# the OLLO documentation will have links to the third party documentation
