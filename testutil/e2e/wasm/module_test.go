...
// 	bz, sdkerr := q(ctx, []string{keeper.QueryListCode}, abci.RequestQuery{})
...
// 	path := []string{keeper.QueryGetCode, fmt.Sprintf("%d", codeID)}
...
// 	bz, sdkerr := q(ctx, []string{keeper.QueryListContractByCode, fmt.Sprintf("%d", codeID)}, abci.RequestQuery{})
// 	require.NoError(t, sdkerr)
...
// 	t.Helper()
// 	path := []string{keeper.QueryGetContractState, contractBech32Addr, keeper.QueryMethodContractStateAll}
// 	bz, sdkerr := q(ctx, path, abci.RequestQuery{})
// 	require.NoError(t, sdkerr)
...
// 	t.Helper()
// 	path := []string{keeper.QueryGetContract, contractBech32Addr}
// 	bz, sdkerr := q(ctx, path, abci.RequestQuery{})
// 	require.NoError(t, sdkerr)
