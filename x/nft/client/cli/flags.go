...
func init() {
	...
	FsSendNFT.String(FlagURI, "[do-not-modify]", "URI for the supplemental off-chain token data (should return a JSON object)")
	FsSendNFT.String(FlagURIHash, "[do-not-modify]", "The uri_hash is a hash of the document pointed by uri. Optional")
	FsSendNFT.String(FlagData, "[do-not-modify]", "The token data of the nft")
	FsSendNFT.String(FlagTokenName, "[do-not-modify]", "The name of the nft")
