...
type MsgClaim struct {
	...
	ConditionType ConditionType `protobuf:"varint,3,opt,name=condition_type,json=conditionType,proto3,enum=ollo.claim.ConditionType" json:"condition_type,omitempty"`
}
...
func (*MsgClaim) Descriptor() ([]byte, []int) {
	return fileDescriptor_a0131bfb6dea4b39, []int{0}
}
...
func (*MsgClaimResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_a0131bfb6dea4b39, []int{1}
}
...
func init() {
	proto.RegisterType((*MsgClaim)(nil), "ollo.claim.MsgClaim")
	proto.RegisterType((*MsgClaimResponse)(nil), "ollo.claim.MsgClaimResponse")
}

func init() { proto.RegisterFile("ollo/claim/tx.proto", fileDescriptor_a0131bfb6dea4b39) }

var fileDescriptor_a0131bfb6dea4b39 = []byte{
	// 261 bytes of a gzipped FileDescriptorProto
	,
}
...
func (c *msgClient) Claim(ctx context.Context, in *MsgClaim, opts ...grpc.CallOption) (*MsgClaimResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/ollo.claim.Msg/Claim", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_Claim_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/ollo.claim.Msg/Claim",
	}
