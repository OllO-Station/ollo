...
// source: ollo/claim/v1beta1/claim.proto
...
func (ConditionType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_245cb93096e2e896, []int{0}
}
...
type Airdrop struct {
	...
	Conditions []ConditionType `protobuf:"varint,3,rep,packed,name=conditions,proto3,enum=ollo.claim.v1beta1.ConditionType" json:"conditions,omitempty"`
...
type ClaimRecord struct {
	...
	ClaimedConditions []ConditionType `protobuf:"varint,5,rep,packed,name=claimed_conditions,json=claimedConditions,proto3,enum=ollo.claim.v1beta1.ConditionType" json:"claimed_conditions,omitempty"`
}
...
func (*ClaimRecord) Descriptor() ([]byte, []int) {
	return fileDescriptor_245cb93096e2e896, []int{1}
}
...
func init() {
	proto.RegisterEnum("ollo.claim.v1beta1.ConditionType", ConditionType_name, ConditionType_value)
	proto.RegisterType((*Airdrop)(nil), "ollo.claim.v1beta1.Airdrop")
	proto.RegisterType((*ClaimRecord)(nil), "ollo.claim.v1beta1.ClaimRecord")
}

func init() { proto.RegisterFile("ollo/claim/v1beta1/claim.proto", fileDescriptor_245cb93096e2e896) }

var fileDescriptor_245cb93096e2e896 = []byte{
	// 620 bytes of a gzipped FileDescriptorProto
	,
}
