...
// 	// ratelimitclientproto.RegisterQueryHandlerClient(context.Background(), mux, ratelimitclientproto.NewQueryClient(clientCtx)) //nolint:errcheck
// }
//
...
// 	// return ratelimitclientcli.GetQueryCmd()
// // }
//
