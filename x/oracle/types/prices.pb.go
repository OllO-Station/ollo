...
func (*Market) Descriptor() ([]byte, []int) {
	return fileDescriptor_3a2e5be08bdb398e, []int{2}
}
...
func (m *Market) GetScriptID() uint64 {
	if m != nil {
		return m.ScriptID
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*Market)(nil), "ollo.oracle.Market")
}
...
var fileDescriptor_3a2e5be08bdb398e = []byte{
	...
	,
}
...
func (m *Market) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if m.ScriptID != 0 {
		i = encodeVarintPrices(dAtA, i, uint64(m.ScriptID))
		i--
		dAtA[i] = 0x10
	}
	if len(m.Symbol) > 0 {
		...
		i = encodeVarintPrices(dAtA, i, uint64(len(m.Symbol)))
		i--
		dAtA[i] = 0xa
	}
	return len(dAtA) - i, nil
...
func (m *Market) Size() (n int) {
	...
	if m.ScriptID != 0 {
		n += 1 + sovPrices(uint64(m.ScriptID))
	}
	return n
}
