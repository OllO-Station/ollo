...
func GetCmdCreateAuction() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types.NewMsgCreateAuction(denomId, nftId, startTime, duration, startPrice, owner, increment)
...
func GetCmdCancelAuction() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types.NewMsgCancelNftAuction(auctionId, owner)
			if err := msg.ValidateBasic(); err != nil {
				return err
			}
...
func GetCmdPlaceBid() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			msg := types.NewMsgPlaceNftBid(auctionId, amount, buyer)
