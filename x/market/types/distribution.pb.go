...
// source: ollo/market/v1/distribution.proto
...
func (*Distribution) Descriptor() ([]byte, []int) {
	return fileDescriptor_1e15f58f1b8d4336, []int{0}
}
...
func init() { proto.RegisterFile("ollo/market/v1/distribution.proto", fileDescriptor_1e15f58f1b8d4336) }

var fileDescriptor_1e15f58f1b8d4336 = []byte{
	// 278 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0xe2, 0x52, 0xcc, 0xcf, 0xc9, 0xc9,
	0xd7, 0xcf, 0x4d, 0x2c, 0xca, 0x4e, 0x2d, 0xd1, 0x2f, 0x33, 0xd4, 0x4f, 0xc9, 0x2c, 0x2e, 0x29,
	...
	0x83, 0x58, 0x10, 0x55, 0x4a, 0xb7, 0x18, 0xb9, 0x78, 0x5c, 0x90, 0x34, 0x0b, 0x45, 0x71, 0xb1,
	0x17, 0x97, 0x24, 0x66, 0x67, 0xe6, 0xa5, 0x4b, 0x30, 0x2a, 0x30, 0x6a, 0x70, 0x3a, 0x39, 0x9c,
	...
	0xa9, 0x2c, 0x48, 0x2d, 0xd6, 0x73, 0x49, 0x4d, 0xfe, 0x74, 0x4f, 0x9e, 0xaf, 0x32, 0x31, 0x37,
	0xc7, 0x4a, 0x09, 0x6a, 0x8c, 0x52, 0x10, 0xcc, 0x40, 0xa1, 0x3c, 0x2e, 0xbe, 0xe4, 0xfc, 0xdc,
	0xdc, 0xd2, 0xbc, 0xcc, 0x92, 0xca, 0xf8, 0x82, 0xfc, 0xfc, 0x1c, 0x09, 0x26, 0xb0, 0x15, 0xee,
	0x24, 0x5b, 0x21, 0x0a, 0xb1, 0x02, 0xd5, 0x34, 0xa5, 0x20, 0x5e, 0xb8, 0x40, 0x40, 0x7e, 0x7e,
	0x8e, 0x53, 0xe8, 0x89, 0x87, 0x72, 0x0c, 0x17, 0x1e, 0xca, 0x31, 0x3c, 0x78, 0x28, 0xc7, 0xb8,
	...
	0xd9, 0x0c, 0x0a, 0x37, 0xdd, 0xe2, 0x92, 0x44, 0x50, 0x70, 0x80, 0x39, 0xfa, 0x15, 0xb0, 0x90,
	0x06, 0x3b, 0x21, 0x89, 0x0d, 0x1c, 0x74, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0xec, 0xdd,
	0x7d, 0x11, 0x85, 0x01, 0x00, 0x00,
}

func (this *Distribution) VerboseEqual(that interface{}) error {
	if that == nil {
		if this == nil {
			return nil
		}
	...
	if !ok {
		...
		if ok {
			...
			return fmt.Errorf("that is not of type *Distribution")
		}
	}
	if that1 == nil {
		if this == nil {
		...
		return fmt.Errorf("that is type *Distribution but is nil && this != nil")
	} else if this == nil {
		return fmt.Errorf("that is type *Distribution but is not nil && this == nil")
	}
	if !this.Staking.Equal(that1.Staking) {
		return fmt.Errorf("Staking this(%v) Not Equal that(%v)", this.Staking, that1.Staking)
	}
	if !this.CommunityPool.Equal(that1.CommunityPool) {
		return fmt.Errorf("CommunityPool this(%v) Not Equal that(%v)", this.CommunityPool, that1.CommunityPool)
	}
	return nil
}
