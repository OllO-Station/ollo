...
func TestGenesisContractInfoMarshalUnmarshal(t *testing.T) {
	...
	myExtension, err := govv1beta1types.NewProposal(&govv1beta1types.TextProposal{Title: "bar"}, 1, anyTime, anyTime)
	...
	var destExt govv1beta1types.Proposal
