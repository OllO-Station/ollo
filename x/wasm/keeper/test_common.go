...
func govProposalHandlers() []govclient.ProposalHandler {
...
func createTestInput(
	...
	govRouter := govtypes1.NewRouter().
		AddRoute(govtypes.RouterKey, govtypes1.ProposalHandler).
	...
	govKeeper := govkeeper.NewKeeper(
		...
		subspace(govtypes.ModuleName).WithKeyTable(govtypesv1.ParamKeyTable()),
		accountKeeper,
		bankKeeper,
		stakingKeeper,
		govRouter,
