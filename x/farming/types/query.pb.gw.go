...
var (
	pattern_Query_Params_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ollo", "farming", "v1", "params"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Plans_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ollo", "farming", "v1", "plans"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Plan_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ollo", "farming", "v1", "plans", "plan_id"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Stakings_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ollo", "farming", "v1", "stakings", "farmer"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_TotalStakings_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ollo", "farming", "v1", "total_stakings", "staking_coin_denom"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_Rewards_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3, 1, 0, 4, 1, 5, 4}, []string{"ollo", "farming", "v1", "rewards", "farmer"}, "", runtime.AssumeColonVerbOpt(true)))

	pattern_Query_CurrentEpochDays_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"ollo", "farming", "v1", "current_epoch_days"}, "", runtime.AssumeColonVerbOpt(true)))
)
