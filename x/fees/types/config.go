...
func NewDefaultMempoolFeeOptions() MempoolFeeOptions {
	return MempoolFeeOptions{
		...
		MinGasPriceForArbitrageTx: DefaultMinGasPriceForArbitrageTx,
		HighGasTxThreshold:        DefaultHighGasTxThreshold,
		MinGasPriceForHighGasTx:   DefaultMinGasPriceForHighGasTx,
	}
}
...
func parseMinGasPriceForArbitrageTx(opts servertypes.AppOptions) sdk.Dec {
	return parseDecFromConfig(opts, "arbitrage-min-gas-fee", DefaultMinGasPriceForArbitrageTx)
}

func parseMinGasPriceForHighGasTx(opts servertypes.AppOptions) sdk.Dec {
	return parseDecFromConfig(opts, "min-gas-price-for-high-gas-tx", DefaultMinGasPriceForHighGasTx)
}
