...
var fileDescriptor_7961e939ee5a0ee2 = []byte{
	...
	,
}

func (this *RangedPool) VerboseEqual(that interface{}) error {
	if that == nil {
		if this == nil {
			return nil
		}
	...
	that1, ok := that.(*RangedPool)
	if !ok {
		that2, ok := that.(RangedPool)
		if ok {
			that1 = &that2
		} else {
			return fmt.Errorf("that is not of type *RangedPool")
		}
	}
	if that1 == nil {
		if this == nil {
		...
		return fmt.Errorf("that is type *RangedPool but is nil && this != nil")
	} else if this == nil {
		return fmt.Errorf("that is type *RangedPool but is not nil && this == nil")
	}
	if this.Id != that1.Id {
...
func (this *RangedPool) Equal(that interface{}) bool {
	if that == nil {
		return this == nil
	}
...
func (m *RangedPool) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.Id) > 0 {
		i -= len(m.Id)
		copy(dAtA[i:], m.Id)
		i = encodeVarintRanged(dAtA, i, uint64(len(m.Id)))
		i--
		dAtA[i] = 0xa
	}
