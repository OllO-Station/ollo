...
var (
	...
	_ sdk.Msg = (*MsgCreateIntelligentPool)(nil)
...
const (
	...
	TypeMsgCreateIntelligentPool = "create_Intelligent_pool"
...
func (msg MsgCreatePair) GetCreatorAddress() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Creator)
	if err != nil {
		panic(err)
	}
...
// NewMsgCreateIntelligentPool creates a new MsgCreateIntelligentPool.
func NewMsgCreateIntelligentPool(
	creator sdk.AccAddress,
	pairId uint64,
	depositCoins sdk.Coins,
	minPrice sdk.Dec,
...
) *MsgCreateIntelligentPool {
	return &MsgCreateIntelligentPool{
		Creator:      creator.String(),
		PairId:       pairId,
		DepositCoins: depositCoins,
		MinPrice:     minPrice,
...
func (msg MsgCreateIntelligentPool) Route() string { return RouterKey }

func (msg MsgCreateIntelligentPool) Type() string { return TypeMsgCreateIntelligentPool }

func (msg MsgCreateIntelligentPool) ValidateBasic() error {
	if _, err := sdk.AccAddressFromBech32(msg.Creator); err != nil {
		return sdkerrors.Wrapf(sdkerrors.ErrInvalidAddress, "invalid creator address: %v", err)
	}
	if msg.PairId == 0 {
	...
	if err := amm.ValidateIntelligentPoolParams(msg.MinPrice, msg.MaxPrice, msg.InitialPrice); err != nil {
		return sdkerrors.Wrap(sdkerrors.ErrInvalidRequest, err.Error())
	}
	return nil
}

func (msg MsgCreateIntelligentPool) GetSignBytes() []byte {
	return sdk.MustSortJSON(ModuleCdc.MustMarshalJSON(&msg))
}

func (msg MsgCreateIntelligentPool) GetSigners() []sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Creator)
	if err != nil {
		panic(err)
	}
...
func (msg MsgCreateIntelligentPool) GetCreatorAddress() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Creator)
	if err != nil {
		panic(err)
	}
...
func (msg MsgDeposit) GetDepositorAddress() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Depositor)
	if err != nil {
		panic(err)
	}
...
func (msg MsgWithdraw) GetWithdrawerAddress() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Withdrawer)
	if err != nil {
		panic(err)
	}
...
func (msg MsgLimitOrder) GetOrdererAddress() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Orderer)
	if err != nil {
		panic(err)
	}
...
func (msg MsgMarketOrder) GetOrdererAddress() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Orderer)
	if err != nil {
		panic(err)
	}
...
func (msg MsgMMOrder) GetOrdererAddress() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Orderer)
	if err != nil {
		panic(err)
	}
...
func (msg MsgCancelOrder) GetOrdererAddress() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Orderer)
	if err != nil {
		panic(err)
	}
...
func (msg MsgCancelAllOrders) GetOrdererAddress() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Orderer)
	if err != nil {
		panic(err)
	}
...
func (msg MsgCancelMMOrder) GetOrdererAddress() sdk.AccAddress {
	addr, err := sdk.AccAddressFromBech32(msg.Orderer)
	if err != nil {
		panic(err)
	}
