...
type Order struct {
	...
	Direction OrderDirection `protobuf:"varint,5,opt,name=direction,proto3,enum=ollo.liquidity.v1beta1.OrderDirection" json:"direction,omitempty"`
	...
	Status   OrderStatus `protobuf:"varint,14,opt,name=status,proto3,enum=ollo.liquidity.v1beta1.OrderStatus" json:"status,omitempty"`
}
