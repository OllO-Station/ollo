...
ifeq (cleveldb,$(findstring cleveldb,$(OLLO_BUILD_OPTIONS)))
...
ifeq (,$(findstring nostrip,$(OLLO_BUILD_OPTIONS)))
  ldflags += -w -s
endif
ldflags += $(LDFLAGS)
...
pc:
	protoc -I ./proto -I ./third_party/proto --go_out ./dist `find proto -name '*.proto'`
