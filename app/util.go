...
// Setup initializes a new App with DefaultNodeHome for integration tests
...
func GetWasmOpts() wasmkeeper.Option {
	return wasmkeeper.WithAPICosts(0, 0)
	// return []wasmkeeper.Option{
	// 	wasmkeeper.WithAcceptedAccountTypesOnContractInstantiation()
	// 	wasmkeeper.WithAPICosts(wasmkeeper.DefaultCompileCost, wasmkeeper.DefaultContractMessageDataCost),
	// 	wasmkeeper.WithVMCacheMetrics(prometheus.DefaultRegisterer),
	// 	wasmkeeper.WithGasRegister(wasmkeeper.NewDefaultWasmGasRegister()),
	// 	wasmkeeper.WithMaxQueryStackSize(100),
	// }
}
